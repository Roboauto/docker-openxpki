...
SCEP_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-gwcar/CN=RoboAuto CA-One SCEP RA 1'
...
DATAVAULT_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-gwcar/DC=RoboAuto Internal/CN=RoboAuto CA-One DataVault'
