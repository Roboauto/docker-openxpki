...
SCEP_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-gwrs/CN=RoboAuto CA-One SCEP RA 1'
...
DATAVAULT_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-gwrs/DC=RoboAuto Internal/CN=RoboAuto CA-One DataVault'
