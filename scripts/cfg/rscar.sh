...
ROOT_CA='RoboAuto_CA-RSCAR_Root_CA'
...
ROOT_CA_SUBJECT='/CN=RoboAuto CA-RSCAR Root CA 1'
ROOT_CA_SERVER_FQDN='rootca.roboauto.cz'

# issuing CA signed by root CA above
ISSUING_CA='RoboAuto_CA-RSCAR_Issuing_CA'
...
ISSUING_CA_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-rscar/CN=RoboAuto Issuing CA 1'

# SCEP registration authority certificate signed by root CA above
SCEP='RoboAuto_CA-RSCAR_SCEP_RA'
...
SCEP_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-rscar/CN=RoboAuto CA-RSCAR SCEP RA 1'

# Apache WEB certificate signed by root CA above
WEB='RoboAuto_CA-RSCAR_Web_CA'
...
WEB_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-rscar/CN=issuing.ca-rscar.roboauto.cz'
WEB_SERVER_FQDN='issuing.ca-rscar.roboauto.cz'

# data vault certificate selfsigned
DATAVAULT='RoboAuto_CA-RSCAR_DataVault'
...
DATAVAULT_SUBJECT='/DC=net/DC=RoboAuto/DC=ca-rscar/DC=RoboAuto Internal/CN=RoboAuto CA-RSCAR DataVault'
...
ROOT_CA_CERTIFICATE_STRING="RoboAuto_CA-RSCAR_Root_CA"
...
ln -s "${ISSUING_CA_KEY}" "${SSL_REALM}/ca-rscar-signer-1.pem"
ln -s "${SCEP_KEY}" "${SSL_REALM}/ca-rscar-scep-1.pem"
ln -s "${DATAVAULT_KEY}" "${SSL_REALM}/ca-rscar-vault-1.pem"

echo "Place web certificate, private key, ... in web server configuration to enable ssl on openxpki web pages!"
echo ""
echo "RoboAuto configuration should be done now, 'openxpkictl start' to fire up server'"
echo ""
echo "Thanks for using RoboAuto - Have a nice day ;)"
echo ""
